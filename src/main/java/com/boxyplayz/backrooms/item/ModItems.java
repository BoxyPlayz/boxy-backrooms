...
public class ModItems {
	...
	public static final Item GRAY_ALMOND_WATER = registerItem("gray_almond_water", Item::new, new Item.Properties()
			.food(new FoodProperties.Builder().nutrition(5).saturationModifier(1f).alwaysEdible().build()));

	public static final Item ROYAL_RATION = registerItem("royal_ration", Item::new, new Item.Properties()
			.food(new FoodProperties.Builder().nutrition(20).saturationModifier(8f).build()));

	public static final Item GREEN_ALMOND_WATER = registerItem("green_almond_water", Item::new, new Item.Properties()
	...
	public static final Item RED_ALMOND_WATER = registerItem("red_almond_water", Item::new, new Item.Properties()
			.food(new FoodProperties.Builder().nutrition(4).saturationModifier(1f).alwaysEdible().build(),
					Consumables.defaultFood()
							.onConsume(new ApplyStatusEffectsConsumeEffect(
