...
public class ModDimensions {
        ...
        public static final ResourceKey<Level> LEVEL2_DIMENSION = ResourceKey.create(
                        Registries.DIMENSION,
                        Identifier.fromNamespaceAndPath(BoxysBackrooms.MOD_ID, "level2"));

        public static final ResourceKey<Level> LEVEL4_DIMENSION = ResourceKey.create(
                        Registries.DIMENSION,
                        Identifier.fromNamespaceAndPath(BoxysBackrooms.MOD_ID, "level4"));

        public static final ResourceKey<Level> BROKEN_DIMENSION = ResourceKey.create(
                        Registries.DIMENSION,
                        Identifier.fromNamespaceAndPath(BoxysBackrooms.MOD_ID, "the_broken"));

        public static final ResourceKey<Level> LEVEL11_DIMENSION = ResourceKey.create(
                        Registries.DIMENSION,
                        Identifier.fromNamespaceAndPath(BoxysBackrooms.MOD_ID, "level11"));

        public static final ResourceKey<Level> LEVEL9_DIMENSION = ResourceKey.create(
                        Registries.DIMENSION,
                        Identifier.fromNamespaceAndPath(BoxysBackrooms.MOD_ID, "level9"));

        public static final ResourceKey<Level> LEVEL10_DIMENSION = ResourceKey.create(
                        Registries.DIMENSION,
