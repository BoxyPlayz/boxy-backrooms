package com.boxyplayz.backrooms.common.entity.living.Partygoer;
...
public class PartygoerEntity extends PathfinderMob {
	...
	public static boolean CheckSpawnRules(final EntityType<PartygoerEntity> type, final ServerLevelAccessor level,
		...
		return level.getBlockState(pos.below())
				.is(ResourceKey.create(Registries.BLOCK,
						Identifier.fromNamespaceAndPath(BoxysBackroomsCommon.MOD_ID, "fun_floor")))
	...
	protected void registerGoals() {
		...
		this.targetSelector.addGoal(3, new NearestAttackableTargetGoal<PartypooperEntity>(
